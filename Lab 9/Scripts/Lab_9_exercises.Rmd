...
#echo-false-example is the name and everything after is the argument
#echo hig all the actual code and only shows output
...
knitr::kable(shark_summary, 
             digits = 1)
#digits= one is rounding to one decimal
```
